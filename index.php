        ...
        <div class="wrapper">
            ...
            <section class="module pt-0 pb-0">
                <div class="container-fluid p-0">
                    <div class="row no-gutters">
                        <div class="col-md-12">
                            <div class="space" data-mt="-100px"></div>
                            <div class="owl-carousel portfolio-carousel" data-carousel-options="{&quot;nav&quot;: true}">
                                <div class="portfolio-item branding bg-dark">
                                    <div class="portfolio-item-wrapper">
                                        <div class="portfolio-item-img"><img src="assets/images/portfolio/1.jpg" alt=""></div>
                                        <div class="portfolio-item-caption">
                                            <h5 class="portfolio-item-title">Modulamp</h5><span class="portfolio-item-subtitle serif">Digital</span>
                                        </div><a class="portfolio-item-link" href="portfolio-single-1.html"></a>
                                    </div>
                                </div>
                                <div class="portfolio-item digital bg-dark">
                                    <div class="portfolio-item-wrapper">
                                        <div class="portfolio-item-img"><img src="assets/images/portfolio/2.jpg" alt=""></div>
                                        <div class="portfolio-item-caption">
                                            <h5 class="portfolio-item-title">Monochrome</h5><span class="portfolio-item-subtitle serif">Branding, Photo</span>
                                        </div><a class="portfolio-item-link" href="portfolio-single-1.html"></a>
                                    </div>
                                </div>
                                <div class="portfolio-item packaging bg-dark">
                                    <div class="portfolio-item-wrapper">
                                        ...
                                        <div class="portfolio-item-caption">
                                            <h5 class="portfolio-item-title">Ellie Cashman</h5><span class="portfolio-item-subtitle serif">Packaging</span>
                                        </div><a class="portfolio-item-link" href="portfolio-single-1.html"></a>
                                    </div>
                                </div>
                                <div class="portfolio-item branding bg-dark">
                                    <div class="portfolio-item-wrapper">
                                        ...
                                        <div class="portfolio-item-caption">
                                            <h5 class="portfolio-item-title">Solave Cleanser</h5><span class="portfolio-item-subtitle serif">Digital</span>
                                        </div><a class="portfolio-item-link" href="portfolio-single-1.html"></a>
                                    </div>
                                </div>
                                <div class="portfolio-item digital bg-dark">
                                    <div class="portfolio-item-wrapper">
                                        ...
                                        <div class="portfolio-item-caption">
                                            <h5 class="portfolio-item-title">Monochrome</h5><span class="portfolio-item-subtitle serif">Branding</span>
                                        </div><a class="portfolio-item-link" href="portfolio-single-1.html"></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="icon-box text-center">
                                ...
                                <div class="icon-box-content">
                                    <p>See how your users experience your website in realtime.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
            ...
            <section class="module bg-dark parallax" data-background="" data-overlay="1" data-gradient="1">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <div class="counter">
                                ...
                                <div class="counter-number">
                                    <h3>
                                        <div class="counter-timer" data-from="0" data-to="2538">0</div>
                                    </h3>
                                </div>
                        ...
                        <div class="col-md-3 text-center">
                            <div class="counter">
                                <div class="counter-icon"><span class="icon-cup icons"></span></div>
                                <div class="counter-number">
                                    <h3>
                                        <div class="counter-timer" data-from="0" data-to="3124">0</div>
                                    </h3>
                                </div>
                        ...
                        <div class="col-md-3 text-center">
                            <div class="counter">
                                ...
                                <div class="counter-number">
                                    <h3>
                                        <div class="counter-timer" data-from="0" data-to="4128">0</div>
                                    </h3>
                                </div>
                        ...
                        <div class="col-md-3 text-center">
                            <div class="counter">
                                ...
                                <div class="counter-number">
                                    <h3>
                                        <div class="counter-timer" data-from="0" data-to="5534">0</div>
                                    </h3>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 order-lg-2">
                            <p class="text-center"><img src="assets/images/main/iphone.png" alt=""></p>
                        </div>
                        <div class="col-lg-3 offset-lg-1 order-lg-1">
                            <div class="icon-box text-lg-right">
                                <div class="icon-box-icon"><span class="fab fa-chrome"></span></div>
                                <div class="icon-box-title">
                                    <h6>Live Examples</h6>
                                </div>
                                <div class="icon-box-content">
                                    <p>See how your users experience your website in realtime or view trends to see any changes.</p>
                                </div>
                            </div>
                            <div class="icon-box text-lg-right">
                                <div class="icon-box-icon"><span class="far fa-object-ungroup"></span></div>
                                <div class="icon-box-title">
                                    <h6>Responsive Desing</h6>
                                </div>
                                <div class="icon-box-content">
                                    <p>See how your users experience your website in realtime or view trends to see any changes.</p>
                                </div>
                        ...
                        <div class="col-lg-3 order-lg-3">
                            <div class="icon-box">
                                <div class="icon-box-icon"><span class="fas fa-spinner"></span></div>
                                <div class="icon-box-title">
                                    <h6>Pug Template Engine</h6>
                                </div>
                                <div class="icon-box-content">
                                    <p>See how your users experience your website in realtime or view trends to see any changes.</p>
                                </div>
                            ...
                            <div class="icon-box">
                                <div class="icon-box-icon"><span class="fab fa-sass"></span></div>
                                <div class="icon-box-title">
                                    <h6>Gulp &amp; SASS</h6>
                                </div>
                                <div class="icon-box-content">
            ...
            <section class="module divider-top">
                <div class="container">
                    ...
                    <div class="card-deck">
                        <div class="card card-xl js-tilt" data-background="assets/images/blog/5.jpg">
                            <div class="card-body mb-10">
                                <h4><a href="#">Introducing Bright Responsive with Bootstrap 4</a></h4>
                            </div>
                            <div class="card-footer"><a href="#">Read More &rarr;</a></div>
                        </div>
                        <div class="card card-xl js-tilt" data-background="assets/images/blog/3.jpg">
                            <div class="card-body mb-10">
                                <h4><a href="#">Introducing Bright Responsive with Bootstrap 4</a></h4>
                            </div>
                            <div class="card-footer"><a href="#">Read More &rarr;</a></div>
                        </div>
                        <div class="card card-xl js-tilt" data-background="assets/images/blog/7.jpg">
                            <div class="card-body mb-10">
                                <h4><a href="#">Introducing Bright Responsive with Bootstrap 4</a></h4>
                            </div>
                            <div class="card-footer"><a href="#">Read More &rarr;</a></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <p class="lead">Like what you see? <a href="#">See more posts &rarr;</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Callout-->
            <section class="module bg-dark parallax" data-background="assets/images/module-3.jpg" data-overlay="0.5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
...
<!-- Mirrored from themes.2the.me/Bright/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 10:26:18 GMT -->
</html>
